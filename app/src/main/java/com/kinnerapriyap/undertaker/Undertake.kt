...
sealed interface Undertake {
    ...
    data class AlarmsWithStep(
        override val title: Int = R.string.alarms_with_step_title,
        override val navigationKey: NavigationKey = AlarmsWithStepKey
    ) : Undertake
}
